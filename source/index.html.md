...
```json
{
  "dashboard": "android",
  "attributes": {
    "commitHash": "d6cd1e2bd19e03a81132a23b2025920577f84e37",
    "branch": "feature/test",
    "target": "master",
    "prLink": "https://github.com/traveloka/android-v3/pull/1410",
    "author": "fchristysen"
  },
  "useCustomID": "true",
  "customID": "pr-1410",
  "sections": {
    "app": {
      "GeneralApps": [{ "key": "apkSize", "value": 200, "tags": [] }]
    },
    "product": {
      "Flight": [{ "key": "unitTestCoverage", "value": 20, "tags": ["flight"] }],
      "Train": [{ "key": "unitTestCoverage", "value": 30, "tags": ["train"] }]
    },
    "screen": {
      "FlightSearch": [
        { "key": "ttfi", "value": 2000, "tags": ["flight", "ttfi"] },
        { "key": "fps", "value": 40, "tags": ["flight", "fps"] }
      ],
      "TrainSearch": [
        { "key": "ttfi", "value": 1000, "tags": ["flight", "ttfi"] },
        { "key": "fps", "value": 30, "tags": ["flight", "fps"] }
      ]
    }
  }
}
...
```json
{
  ...
  "sections": {
    "app": {
      "GeneralApps": [{ "key": "assetSize", "value": 3000 }]
    }
  }
}
```
    ...
    "app": [
      {
        ...
        "unit": "KB",
        "bounds": [
          { "key": "Google Recomendation Size", "value": 20000 },
          { "key": "Alibaba APK Size", "value": 100000 }
        ]
      },
      {
